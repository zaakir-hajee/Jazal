...
export default function CounterScreen() {
  ...
  const handleRestore = useCallback(async () => {
    try {
      ...
      Alert.alert('Purchases Restored', 'Your purchases have been successfully restored.');
    } catch (e: any) {
...
const styles = StyleSheet.create({
  ...
  restoreBtn: { marginTop: 12, paddingVertical: 8 },
  restoreBtnText: { color: MUTED, fontSize: 11, textAlign: 'center', textDecorationLine: 'underline' },
